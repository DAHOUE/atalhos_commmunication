...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        ...
        <i class="icofont-google-map"></i> Abomey Calavi
      </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#doctors">Publicité</a></li>
      ...
      <a href="#appointment" class="appointment-btn scrollto">Prendre un rendez-vous</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Bienvene à Atalhos Communication</h1>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Création des pages Facebook Pro & Boostage</h4>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">La publicité de vos articles et produits</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Réalisation des spots publicitaire</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Reportage audio-visuel</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Conception des affiches, bâches, carte de visite, affiches publicitaires  </a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Formation en entrepreneuriat</a></h4>
      ...
      <div class="container">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
              <input type="tel" class="form-control" name="phone" id="phone" placeholder="Votre contact phone" data-rule="minlen:4" data-msg="Veuillez entrer un contact valide">
              <div class="validate"></div>
            </div>
          </div>
          <div class="form-row">
            <div class="col-md-4 form-group">
              <input type="datetime" name="date" class="form-control datepicker" id="date" placeholder="Date de rendez-vous" data-rule="minlen:4" data-msg="Veuillez entrer au moins 4 caractères">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group">
